...
```
## Brief analysis of the Cancer Risk Factors Dataset from Kaggle [Link to dataset](https://example.com/data)
...
cancer_risk_factors %>% 
  ...
  labs(x = "Age", title = "Prevalence of Cancer", y="") + 
  theme(
...
ggplot(cancer_risk_factors_long, 
       aes(x = Overall_Risk_Score, y = Value, color = Risk_Factors)) +
